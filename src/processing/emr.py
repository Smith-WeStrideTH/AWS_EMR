...
class EMRServerless:
    """
    An implementation of running a PySpark job on EMR Serverless.
        ...
        response = self.client.start_job_run(
            ...
            jobDriver={
                "sparkSubmit": {
                    ...
                    "sparkSubmitParameters": f"--conf spark.executor.cores=4 "
                                             f"--conf spark.executor.memory=16g "
                                             f"--conf spark.driver.cores=4 "
                                             f"--conf spark.driver.memory=8g "
                                             f"--conf spark.executor.instances=10 "
